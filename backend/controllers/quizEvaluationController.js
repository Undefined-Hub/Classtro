...
const evaluateQuizSubmission = async (submission) => {
  try {
    ...
    for (const question of quiz.questions) {
      const qPoints = (question.points || 1) * 100;
      const qNegativePoints = (question.negativePoints || 0) * 100;
    ...
    submission.percentage = maxScore > 0 ? Math.min(100, (score / maxScore) * 100) : 0;
