...
const ParticipantQnA = ({ questions, onUpvote, askOpen, setAskOpen, onBack }) => {
    return (
        <div className="max-w-xs sm:max-w-md lg:max-w-lg mx-auto px-1 sm:px-0">
            ...
            <div className="p-2 sm:p-4 lg:p-6 flex flex-col" style={{ height: 'min(80vh, 600px)', minHeight: '350px' }}>
                {/* Header */}
                    ...
                    {questions.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full text-center px-4">
                            <p className="text-gray-500 dark:text-gray-400 mb-4 sm:mb-6 text-sm sm:text-base leading-relaxed">
                                Do you have a question for the presenter?<br />Be the first one to ask!
                            </p>
                        </div>
                    ) : (
