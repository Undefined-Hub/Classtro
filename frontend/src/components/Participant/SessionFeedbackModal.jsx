    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[10000] flex items-center justify-center p-5 transition-all duration-300">
      ...
      >
        ...
        <div className="px-6 pt-4 pb-2">
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-lg px-4 py-3 border border-blue-200 dark:border-blue-700">
            <div className="flex items-center justify-center gap-3 text-base">
              <div className="flex items-center gap-2">
                <span className="text-blue-600 dark:text-blue-400 font-bold">Session:</span>
                <span className="font-bold text-gray-900 dark:text-white">{sessionTitle || "Untitled Session"}</span>
              </div>
              {roomName && (
                <>
                  <span className="text-gray-400 font-bold">•</span>
                  <div className="flex items-center gap-2">
                    <span className="text-blue-600 dark:text-blue-400 font-bold">Room:</span>
                    <span className="font-bold text-gray-900 dark:text-white">{roomName}</span>
                  </div>
                </>
              )}
            </div>
