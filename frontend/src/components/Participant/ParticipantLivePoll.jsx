...
const ParticipantLivePoll = ({ onVote }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-lg p-8 max-w-md mx-auto mt-12 animate-fade-in">
        ...
        {activePoll.options?.map((opt) => {
          ...
          return (
            <button
              ...
              className={`relative w-full text-left rounded-xl border transition-all group shadow-sm overflow-hidden px-0 py-0
                ${
                  isSelected
            ...
            >
              ...
              <div className="relative flex items-center justify-between px-4 py-3 z-10">
                ...
                <span className="ml-4 px-3 py-1 rounded-lg bg-white/80 dark:bg-gray-900/60 text-xs font-semibold text-gray-700 dark:text-gray-200 min-w-[2.5rem] text-center border border-gray-200 dark:border-gray-700">
      ...
      {pollSubmitted && (
        <div className="mt-6 text-green-600 dark:text-green-400 text-base font-medium">
