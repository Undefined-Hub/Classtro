      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl w-full max-w-7xl h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              {participants.length} total participants • Showing{" "}
              {paginatedParticipants.length} per page
            </p>
          </div>
          <button
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200 dark:border-gray-700">
          <div className="text-sm text-gray-500 dark:text-gray-400">
            ...
            to {Math.min(currentPage * itemsPerPage, participants.length)} of{" "}
      ...
      <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div>
            <p className="text-lg font-semibold text-gray-900 dark:text-white">
              {Math.round(
                participants.reduce((acc, p) => acc + p.duration, 0) /
                  participants.length,
              )}
              m
            </p>
          ...
          <div>
            <p className="text-lg font-semibold text-gray-900 dark:text-white">
              {Math.round(
                (participants.filter((p) => p.duration >= 30).length /
                  participants.length) *
                  100,
              )}
              %
