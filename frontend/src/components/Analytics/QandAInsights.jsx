    ...
    >
      <div className="flex items-start justify-between mb-2">
        <div className="flex-1">
          <p
            className={`${isInModal ? "text-base" : "text-sm"} font-medium text-gray-900 dark:text-white mb-1`}
          >
            {question.text}
          </p>
        ...
        <div className="flex-1 flex flex-col min-h-0">
          <div className="flex items-center justify-between mb-3 flex-shrink-0">
            <h4 className="text-sm font-medium text-gray-900 dark:text-white">
              Recent Questions (
              {Math.min(sortedQuestions.length, maxVisibleQuestions)} of{" "}
          ...
          <div className="flex-1 overflow-y-auto space-y-3 pr-2 hide-scrollbar">
            ...
            {sortedQuestions.length > maxVisibleQuestions && (
              <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 text-center">
                ...
                >
                  + {sortedQuestions.length - maxVisibleQuestions} more
                  questions
                </button>
