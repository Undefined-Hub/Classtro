      ...
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <a href="/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
            <span className="self-center text-2xl font-semibold text-blue-600 whitespace-nowrap dark:text-blue-500">Classtro</span>
          </a>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="block text-sm text-gray-500 sm:text-left dark:text-gray-400">
            © {new Date().getFullYear()} <a href="/" className="hover:underline">Classtro</a>. All Rights Reserved.
          </span>
