      ...
      <section className="bg-white dark:bg-gray-900 mt-20">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
            Run live polls, quizzes, and interactive Q&A to make every session
            engaging - whether in classrooms, meetings, or large events.
          </p>
          ...
          <div className="mt-20">
            <h2 className="text-3xl font-extrabold text-gray-800 dark:text-white mb-4">
              <span className="bg-gradient-to-r from-blue-500 to-blue-400 bg-clip-text text-transparent">
                Who Can Use Classtro
              </span>
            </h2>
            <p className="text-gray-600 dark:text-gray-300 mb-10 max-w-3xl mx-auto">
              Our platform is designed to meet the needs of various environments
              where audience engagement is key
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
              <div className="p-6 rounded-xl bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
                ...
                <h3 className="font-bold text-xl text-center text-blue-600 dark:text-white mb-3 group-hover:text-blue-700 dark:group-hover:text-blue-300">
                  Education
                </h3>
                <p className="text-gray-600 dark:text-gray-300 text-center">
                  Interactive classes. Engaged students.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-center">
                  Engage teams and collect instant meeting feedback.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-center">
                  Connect audiences with live polls and Q&A.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-center">
                  Gamify learning and encourage collaboration.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto relative">
              ...
              <div className="flex flex-col md:flex-row items-start mb-12 relative">
                ...
                <div className="md:ml-8 bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg w-full md:w-auto transform transition-all duration-300 hover:shadow-xl">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Set up a new poll, quiz, or Q&A session in just seconds. No
                    complicated setup required — works from any device with a
                    browser.
                  </p>
              ...
              <div className="flex flex-col md:flex-row items-start mb-12 relative">
                ...
                <div className="md:ml-8 bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg w-full md:w-auto transform transition-all duration-300 hover:shadow-xl">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Invite participants to join instantly by sharing a simple
                    6-digit code or displaying the auto-generated QR code. No
                    downloads or accounts needed for participants.
                  </p>
                  <div className="inline-flex items-center text-blue-600 dark:text-blue-300 font-medium">
                    <span>View demo</span>
                    <svg
              ...
              <div className="flex flex-col md:flex-row items-start relative">
                ...
                <div className="md:ml-8 bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg w-full md:w-auto transform transition-all duration-300 hover:shadow-xl">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Launch polls, quizzes, and Q&A sessions with live results.
                    Watch as responses appear instantly and visualize data with
                    beautiful charts.
                  </p>
                  <div className="inline-flex items-center text-blue-600 dark:text-blue-300 font-medium">
