  ...
  const getColorClasses = () => {
    if (colorScheme === "emerald") {
      return {
        ...
        iconText: isSelected
          ? "text-white"
          : "text-emerald-700 dark:text-emerald-200 group-hover:text-white",
        title: isSelected
      ...
      return {
        ...
        iconText: isSelected
          ? "text-white"
          : "text-blue-700 dark:text-blue-200 group-hover:text-white",
        title: isSelected
      ...
      <div className={`h-64 p-6 ${colors.background}`}>
        ...
        {isSelected && (
          <div className="absolute top-4 right-4">
            <div
              className={`w-6 h-6 ${colors.indicator} rounded-full flex items-center justify-center`}
            >
              <svg
        ...
        <div className="flex flex-col items-center text-center h-full justify-between">
          {/* Icon */}
          <div
            className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 transition-all duration-300 ${colors.icon}`}
          >
            <svg
