...
const SessionHeader = ({
  ...
  return (
    <>
      ...
      {activeView === "main" && (
        <div
          className={`fixed top-4 z-40 group transition-all duration-300 ${
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              <span className="text-sm text-blue-50 dark:text-gray-200">
                Join at classtro.live | use code
              </span>
      ...
      {activeView === "main" && (
        ...
        >
          <div className="flex items-center gap-3 bg-blue-600/80 dark:bg-blue-900/20 backdrop-blur-md border border-blue-500/50 dark:border-blue-700/30 text-white rounded-full px-4 py-2 shadow-lg">
            ...
            />
            <span className="text-sm font-semibold text-white">Classtro</span>
          </div>
        </div>
      )}
    </>
