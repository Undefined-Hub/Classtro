          ...
          <div className="w-20 h-20 bg-red-100 dark:bg-red-900/30 rounded-full flex items-center justify-center">
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M12 15v2m0 0v2m0-2h2m-2 0H9m3-4V7a3 3 0 00-3-3H5a3 3 0 00-3 3v6a3 3 0 003 3h7a3 3 0 003-3zm0 0V7a3 3 0 013-3h4a3 3 0 013 3v6a3 3 0 01-3 3h-7a3 3 0 01-3-3z"
              />
            </svg>
          </div>
        </div>
