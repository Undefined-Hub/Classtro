...
export const HostSessionProvider = ({ children }) => {
  ...
  const value = useMemo(() => ({
    ...
    sessionData, activeView, participantsList, questions, activePoll, pastPolls,
    showPollForm, showConfirmClose, broadcastMessage, broadcastStatus, showBroadcastForm
  ]);
