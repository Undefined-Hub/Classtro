...
const generateMockData = (sessionData) => {
  const now = new Date();
  const startTime = sessionData?.startAt
    ...
    questions: [
      {
        ...
        upvotes: 8,
        answered: true,
        createdAt: new Date(startTime.getTime() + 1200000).toISOString(),
      },
      {
        id: 2,
        askedBy: "Anonymous",
        ...
        upvotes: 12,
        answered: true,
        createdAt: new Date(startTime.getTime() + 1800000).toISOString(),
      },
      {
        id: 3,
        askedBy: "Bob Smith",
        ...
        upvotes: 6,
        answered: false,
        createdAt: new Date(startTime.getTime() + 2400000).toISOString(),
      },
      {
        id: 4,
        askedBy: "Carol White",
        text: "How does React state management work?",
        upvotes: 9,
        answered: true,
        createdAt: new Date(startTime.getTime() + 3000000).toISOString(),
      },
      {
        id: 5,
        askedBy: "Anonymous",
        ...
        upvotes: 15,
        answered: true,
        createdAt: new Date(startTime.getTime() + 3600000).toISOString(),
      },
      {
        id: 6,
        askedBy: "David Brown",
        ...
        upvotes: 7,
        answered: false,
        createdAt: new Date(startTime.getTime() + 3900000).toISOString(),
      },
      {
        id: 7,
        askedBy: "Emma Davis",
        ...
        upvotes: 5,
        answered: true,
        createdAt: new Date(startTime.getTime() + 4200000).toISOString(),
      },
      {
        id: 8,
        askedBy: "Anonymous",
        text: "What are web accessibility best practices?",
        upvotes: 10,
        answered: false,
        createdAt: new Date(startTime.getTime() + 4500000).toISOString(),
      },
      {
        id: 9,
        askedBy: "Bob Smith",
        ...
        upvotes: 11,
        answered: true,
        createdAt: new Date(startTime.getTime() + 4800000).toISOString(),
      },
      {
        id: 10,
        askedBy: "Carol White",
        ...
        upvotes: 8,
        answered: true,
        createdAt: new Date(startTime.getTime() + 5100000).toISOString(),
      },
    ],
    feedback: {
      averageRating: 4.3,
...
export const useAnalyticsData = () => {
  ...
  if (!context) {
    throw new Error(
      "useAnalyticsData must be used within an AnalyticsProvider",
    );
  }
  return context;
};
